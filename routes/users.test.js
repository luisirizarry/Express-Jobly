...
// Some of the tests for finding a non existent user but user themselves isnt an admin 
// doesn't make sense, so I removed those tests
...
describe("PATCH /users/:username", () => {
  ...
  test("not found if no such user and is admin", async function () {
    const resp = await request(app)
        .patch(`/users/nope`)
        .send({
          firstName: "Nope",
